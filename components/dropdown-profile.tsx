...
import { useUserInfo, useOrganizationInfo } from '@/lib/hooks'
    ...
    <Menu as="div" className="relative inline-flex">
      ...
      >
        <div className="pt-0.5 pb-2 px-3 mb-1 border-b border-gray-200 dark:border-gray-700/60">
          <div className="font-medium text-gray-800 dark:text-gray-100">{userInfo?.fullName || 'Loading...'}</div>
          <div className="text-xs text-gray-500 dark:text-gray-400 italic">{organizationInfo?.name || 'Loading...'}</div>
        </div>
